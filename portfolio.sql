...
-- Generation Time: Mar 28, 2022 at 07:58 AM
...
(1, 'Website', 'PUSATNUSA', '1636733844Pusatnusa.png', 'The Entrepreneurs Association (PUSATNUSA) is a legal entity organization consisting of entrepreneurs based on the people economy (Pancasila economy) together with the people and users to become pioneers in realizing the goals of the Republic of Indonesia.', 'June 2020', 'Front-End Programmer', 'https://pusatnusa.com/', 'www.pusatnusa.com'),
...
(73, 'UI/UX Design', 'Ravinnee Hotel', '1646743739Group 7.png', 'A website that displays how to book a hotel or resort and provides information to potential customers interactively with social media. There is information about the hotel and other information which can be in the form of images or videos.', 'February 2022', 'UI/UX Designer', 'https://www.figma.com/file/NuxGQmRdO1ObR4o481foZI/Ravinnee-Hotel?node-id=0%3A1', 'www.ravinneehotel.com'),
(74, 'Website', 'Devchallenges Responsive Web Developer', '1647876390Screenshot 2022-03-21 200351.png', 'Learn and practice responsive web development by building 8 websites with given designs.\r\n\r\n', 'March 2022', 'Front-End Programmer', 'https://devchallengesresponsivewebdeveloper.netlify.app/', 'www.devchallenges.io');
...
(15, '1636805493front-end.png', 'Front-End', 'People who play a role in developing the display of a site or application'),
(16, '1636805551ux-design.png', 'Web Design', 'Web design is a form of graphic in create a web page'),
(17, 'ui-design.png', 'UI/UX Design', 'UI design is the beauty of website, and the focus UX design is the user satisfaction');
...
(1, 'dwiputrabayu.oktantyo', 'dwptrbayu', 'dwiputrabayu', 'dpbayu', 'dwptrbayu');
