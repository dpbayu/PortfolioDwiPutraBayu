                    ...
                    <div class="cards">
                        <div class="row">
                            <div class="col" style="margin: 0 20px 20px 20px;">
                                <div class="card-header" style="width: 95%;">
                                ...
                                <form role="form" action="../include/admin.php" method="post"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea style="resize: none;" cols="95" rows="5"
                                                name="desc"><?=$user_data['about_desc']?></textarea>
                                        </div>
                                        <!-- About Desc -->
                                    </div>
                                    <div class="card-footer">
                            ...
                            <div class="col" style="margin: 0 20px 20px 20px;">
                                ...
                                <div class="row">
                                    <form role="form" action="../include/admin.php" method="post"
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" place name="add-interest" class="btn btn-primary">Add
                                                Interest</button>
                                        </div>
                                    </form>
                                </div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="../include/editskill.php?id=<?=$skill['id']?>">Edit</a>
                                                    </td>
                                                    <td>
                                                        <a
                                    ...
                                    <form role="form" action="../include/admin.php" method="post">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Enter Skill" class="form-control"
                                                    name="skillname">
                                            </div>
                                            <!-- Skill Name -->
                                            <!-- Skill Level -->
                                            <div class="form-group">
                                                ...
                                                <input type="range" min="1" max="100" class="form-control"
                                                    name="skilllevel">
                                                <input type="text" placeholder="Enter from 1 - 100" min="1" max="100"
                                                    class="form-control" name="skilllevel">
                                            </div>
                                            <!-- Skill Level -->
                                        </div>
                                        <div class="card-footer">
                                    ...
                                    <form role="form" action="../include/admin.php" method="post"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Enter Project Date" class="form-control"
                                                    name="project_date">
                                            </div>
                                            <!-- Project Date -->
                                            <!-- Project Role -->
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Enter Project Role" class="form-control"
                                                    name="project_role">
                                            </div>
                                            <!-- Project Role -->
                                            <!-- Project Link -->
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Enter Project Link" class="form-control"
                                                    name="project_link">
                                            </div>
                                            <!-- Project Link -->
                                            <!-- Project Name Link -->
